...
/* harmony import */ var next_dist_compiled_react_server_dom_webpack_server_edge__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(6370);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 6085)), "/home/chandra.kant/Documents/JavaScript-FullStack-Tarining/Quiz-App (Assessment)/quizme-client/app/quiz/page.tsx"],
      ...
      },
        {
          ...
          metadata: {
    icon: [(async (props) => (await Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 2154))).default(props))],
    apple: [],
    openGraph: [],
    twitter: [],
    manifest: undefined
        ...
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 1724)), "/home/chandra.kant/Documents/JavaScript-FullStack-Tarining/Quiz-App (Assessment)/quizme-client/app/layout.tsx"],
          metadata: {
    icon: [(async (props) => (await Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 2154))).default(props))],
    apple: [],
    openGraph: [],
    ...
    const pages = ["/home/chandra.kant/Documents/JavaScript-FullStack-Tarining/Quiz-App (Assessment)/quizme-client/app/quiz/page.tsx"];
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 2355))
...
;// CONCATENATED MODULE: ./components/QuestionCard/helpers.ts
...
;// CONCATENATED MODULE: ./components/QuestionCard/QuestionCard.tsx
// Helpers


const QuestionCard = ({ currentQuestionIndex , question , answers , userAnswer , onClick , correctAnswer  })=>{
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
        children: [
            ...
            /*#__PURE__*/ jsx_runtime_.jsx("div", {
                ...
                children: answers.map((answer)=>/*#__PURE__*/ jsx_runtime_.jsx("div", {
                        onClick: ()=>onClick(answer, currentQuestionIndex),
                        className: `${getBGColor(userAnswer, correctAnswer, answer)} cursor-pointer flex items-center justify-center select-none font-bold min-h-[45px] max-w-[400] w-full my-2 rounded-[10px]`,
...
/* harmony default export */ const QuestionCard_QuestionCard = (QuestionCard);

// EXTERNAL MODULE: ./components/Button/Button.tsx
var Button = __webpack_require__(5425);
;// CONCATENATED MODULE: ./app/quiz/Quiz.tsx
...
const Quiz = ({ questions , totalQuestions  })=>{
    const [currentQuestionIndex, setCurrentQuestionIndex] = react_default().useState(0);
    const [score, setScore] = react_default().useState(0);
    const [userAnswers, setUserAnswers] = react_default().useState({});
    ...
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ jsx_runtime_.jsx(QuestionCard_QuestionCard, {
...
module.exports = createProxy("/home/chandra.kant/Documents/JavaScript-FullStack-Tarining/Quiz-App (Assessment)/quizme-client/app/quiz/Quiz.tsx");
...
;// CONCATENATED MODULE: ./utils/arrayUtils.ts
const shuffleArray = (array)=>[
        ...array
    ].sort(()=>Math.random() - 0.5);

// EXTERNAL MODULE: ./app/quiz/Quiz.tsx
var Quiz = __webpack_require__(340);
var Quiz_default = /*#__PURE__*/__webpack_require__.n(Quiz);
;// CONCATENATED MODULE: ./types/quiz.ts
var Difficulty;
(function(Difficulty) {
...
;// CONCATENATED MODULE: ./app/quiz/page.tsx
// Utils
...
const Home = async ()=>{
    ...
    return /*#__PURE__*/ jsx_runtime.jsx((Quiz_default()), {
        questions: questions,
...
var __webpack_exports__ = __webpack_require__.X(0, [961,944,329], () => (__webpack_exec__(995)));
